# ReserveVoice — browser voice agent (Groq + Deepgram), no Vapi

A voice receptionist that takes restaurant reservations in the browser. Instant load (nothing heavy downloads), fast, and effectively free to run for a long time.
